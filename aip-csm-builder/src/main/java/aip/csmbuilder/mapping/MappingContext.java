 ...
 * Module), and a read-only, point-in-time view of which Evidence
 * Items have already produced a CSM element earlier in this
 * orchestration run (see {@link MappingOrchestrator} for the
 * deterministic processing order this view depends on).
 */
